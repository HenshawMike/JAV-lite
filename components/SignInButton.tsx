  ...
  return (
    <div className="flex flex-col gap-3 w-full">
      <Button
        ...
        variant="primary"
        loading={loading}
        className="w-full py-4 text-sm font-bold flex items-center justify-center gap-3 shadow-md hover:shadow-lg rounded-xl"
      >
        {!loading && (
      ...
      {error && (
        <div className="flex items-center justify-center gap-2 text-xs text-error animate-fade-in p-2 bg-error/10 border border-error/20 rounded-lg">
